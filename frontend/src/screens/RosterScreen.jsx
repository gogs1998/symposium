...
function RosterSkeleton() {
  return (
    <div className="sym-roster-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(300px, 1fr))', gap: 'var(--space-5)' }}>
...
export function RosterScreen({ figures, loading, onOpenFigure }) {
  ...
  return (
    <div style={{ minHeight: '100%', background: 'var(--surface-page)', backgroundImage: 'var(--texture-grain)' }}>
      <Masthead />
      <main className="sym-roster-main" style={{ maxWidth: 'var(--width-page)', margin: '0 auto', padding: 'var(--space-10) var(--space-8) var(--space-12)' }}>
        <div style={{ maxWidth: 780, marginBottom: 'var(--space-9)' }}>
          <span className="sym-eyebrow">A room of remarkable people</span>
          <h1 className="sym-roster-h1" style={{ margin: '14px 0 0', font: 'var(--fw-regular) var(--text-5xl)/1.02 var(--font-display)', color: 'var(--text-strong)', textWrap: 'balance' }}>
